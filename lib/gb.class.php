...
class guestbook
{
    ...
    public function get_nav($entry = 0)
    {
        ...
        if ($next_page < $this->total) {
            $navigation .= "   &nbsp;&nbsp;<a href=\"$self$next_page\">" . $this->db->LANG['NavNext'] . "</a><img src=\"$GB_PG[base_url]/img/next.gif\" width=\"16\" height=\"14\">\n";
        }

        return $navigation;
    }

    public function show_entries($entry = 0)
    {
        global $GB_PG;
        ...
        $TPL['GB_HTML_CODE'] = (1 == $this->db->VARS['allow_html']) ? $this->db->LANG['BookMess2'] : $this->db->LANG['BookMess1'];
    ...
    public function generate_JumpMenu()
    {
    ...
    public function get_entries($entry, $last_entry)
    {
