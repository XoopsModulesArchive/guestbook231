...
$GB_DB['dbName'] = 'xoops_forum';
$GB_DB['host'] = 'localhost';
$GB_DB['user'] = 'T.SAKURAI';
$GB_DB['pass'] = 'George';

/* tables */

$GB_TBL['data'] = 'xoops_book_data';
$GB_TBL['auth'] = 'xoops_book_auth';
$GB_TBL['cfg'] = 'xoops_book_config';
$GB_TBL['com'] = 'xoops_book_com';
$GB_TBL['ip'] = 'xoops_book_ip';
$GB_TBL['words'] = 'xoops_book_words';
$GB_TBL['ban'] = 'xoops_book_ban';
$GB_TBL['priv'] = 'xoops_book_private';
$GB_TBL['smile'] = 'xoops_book_smilies';
$GB_TBL['pics'] = 'xoops_book_pics';
