...
<center>
<font size="2" face="Verdana, Arial" color="#313031"><b>EASY&nbsp;&nbsp;&nbsp;&nbsp;ADMIN</b></font><br><br>
</center>
...
if ($prev_page >= 0) {
    echo "  &nbsp;&nbsp;<a href=\"$this->SELF?action=show&amp;tbl=$tbl&amp;entry=$prev_page&amp;session=$this->session&amp;uid=$this->uid\"><font color=\"#FFFF00\" size=\"2\"><b>前のページ</b></font></a>\n";
}
if ($next_page < $total) {
    echo "  &nbsp;&nbsp;<a href=\"$this->SELF?action=show&amp;tbl=$tbl&amp;entry=$next_page&amp;session=$this->session&amp;uid=$this->uid\"><font color=\"#FFFF00\" size=\"2\"><b>次のページ</b></font></a>\n";
}
...
?> </td>
  ...
  <table border="0" cellspacing="1" cellpadding="5" align="center" width="100%" bgcolor="#000000">
    <tr bgcolor="#BCBCDE">
      <td width="30%"><font size="2"><b>お名前</b></font></td>
      <td width="60%"><font size="2"><b>コメント</b></font></td>
      <td width="10%">&nbsp;</td>
    </tr>
...
$id = $total - $entry;
$i = 0;
while (false !== ($row = $this->db->fetch_array($result))) {
    $name = $row['name'];
  ...
  <table border=0 cellspacing=0 cellpadding=2>\n    <tr>
    ...
    if ('gb' == $tbl) {
        ...
        while (false !== ($com = $this->db->fetch_array($this->db->result))) {
    ...
    echo "   </td>
   <td width=\"10%\"><font size=1><b><a href=\"$this->SELF?action=edit&amp;tbl=$tbl&amp;id=$row[id]&amp;record=$id&amp;session=$this->session&amp;uid=$this->uid\">編集</a><br><br>
    <a href=\"$this->SELF?action=del&amp;tbl=$tbl&amp;id=$row[id]&amp;session=$this->session&amp;uid=$this->uid\">削除</a></b></font>
   </td>\n </tr>\n";
