    ...
    <tr>
      <td>
        <p>'Smilies' ili izrazisu male slièice koje mogu da opi¹u neko oseæanje 
          ...
          izraza. U ovom sluèaju odreðene kombinacije slova i karaktera su automatski 
          ...
          ima neki smisao i reflektuje odreðeni izraz.</p>
  ...
  <TABLE border=0 cellPadding=0 cellSpacing=0 width="95%" align="center" height="556">
    ...
    <TD bgColor=#000000>
      <TABLE border=0 cellPadding=4 cellSpacing=1 width="100%">
        <TBODY>
        <TR bgColor=#0099CC>
            <TD><b><font color="#FFFFFF">URL Hiperlinkovanje (naznaèavanje odreðenih 
...
<table width="95%" border="0" cellspacing="1" cellpadding="4" align="center">
    <tr> 
      <td><font color=#800000>Va¾no:</font><br>
        ...
        - nemojte da ostavljate prazno mesto izmeðu primenjenog koda odnosno izmedju 
        kodova.<br>
        <br>
        <font color="#ff0000">[email]</font>webmaster@yufestcaffe.com<font color=#ff0000>[email]</font> 
